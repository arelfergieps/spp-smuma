...
use App\Http\Controllers\KirimTunggakanController;
...
Route::middleware(['auth', 'role:admin'])->group(function () {
    ...
    Route::get('/kirim_tunggakan', [SiswaController::class, 'tunggakan'])->name('kirim_tunggakan.index');
    Route::post('/kirim-tunggakan', [KirimTunggakanController::class, 'store'])->name('kirim_tunggakan.store');
