...
class RombelController extends Controller
{
    ...
    {
        $rombels = Rombel::with(['jurusan', 'tahunAjaran'])->withCount('siswas')->get();
        $jurusans = Jurusan::all();
        $tahun_ajarans = TahunAjaran::all();

        return view('admin.rombel.index', compact('rombels', 'jurusans', 'tahun_ajarans'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            Rombel::create($request->only('rombel', 'tingkat', 'jurusan_id', 'tahun_ajaran_id'));
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            $rombel->update($request->only('rombel', 'tingkat', 'jurusan_id', 'tahun_ajaran_id'));
