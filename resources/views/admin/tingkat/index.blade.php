        ...
        <table class="table table-vcenter card-table">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <!-- Tombol Edit -->
                <button type="button" class="btn btn-sm" data-bs-toggle="modal" data-bs-target="#editTingkatModal{{ $tingkat->id }}">
                  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" stroke="blue" fill="none" viewBox="0 0 24 24"
                    stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                    <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                ...
                <!-- Tombol Hapus -->
                <form action="{{ route('tingkat.destroy', $tingkat->id) }}" method="POST" onsubmit="return confirm('Yakin ingin menghapus tingkat ini?');" style="display:inline;">
                  @csrf
                  @method('DELETE')
                  <button type="submit" style="border: none; background: none; padding: 0;" title="Hapus">
            ...
            <!-- Modal Edit Tingkat -->
            <div class="modal fade" id="editTingkatModal{{ $tingkat->id }}" tabindex="-1" aria-labelledby="editTingkatModalLabel{{ $tingkat->id }}" aria-hidden="true">
                ...
                <div class="modal-content">
                  <form action="{{ route('tingkat.update', $tingkat->id) }}" method="POST">
                    ...
                    <div class="modal-header">
                      <h5 class="modal-title" id="editTingkatModalLabel{{ $tingkat->id }}">Edit Tingkat</h5>
                      <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Tutup"></button>
                    </div>
                    <div class="modal-body">
                      <div class="mb-3">
                        <label for="tingkat" class="form-label">Tingkat</label>
                        <input type="text" class="form-control" name="tingkat" value="{{ $tingkat->tingkat }}" required>
                      </div>
                    </div>
